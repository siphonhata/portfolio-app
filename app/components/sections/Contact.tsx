              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:your.email@example.com" className="text-dark-400 dark:text-dark-200 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+1234567890" className="text-dark-400 dark:text-dark-200 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                      +1 (234) 567-890
                    </a>
                  </div>
                </div>
